...
public class Department implements Cloneable{
	...
	public String toString() {
		...
		result.append("   Location: "+ this.getLocation());
		result.append("   Postions: "+ positions);
		return result.toString();
		
	}
	@Override
	public Object clone() throws CloneNotSupportedException {
		Department copyDept = (Department) super.clone();
		copyDept.company = (Company) company.clone();
		return copyDept;		
	}
