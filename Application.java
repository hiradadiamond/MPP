...
public class Application {
	...
	public static void main(String[] args) {
		...
		Position seniorSalesManPosition1 = new Position("Senior-SalesMan1", "Senior-SalesMAN", salesDeptHeadPosition, salesDepartment);
		Position seniorSalesManPosition2 = new Position("Senior-SalesMan2", "Senior-SalesMAN", salesDeptHeadPosition, salesDepartment);
		...
		Employee deptHeadSalesPerson = new Employee("Ron","","", "3 July 1995", "2340-2353",90000, salesDeptHeadPosition);
		Employee seniorSalesPerson1 = new Employee("Stan", " ", "","1 dec 1993","2333-44112", 8000,seniorSalesManPosition1);
		Employee seniorSalesPerson2 = new Employee("Peter", " ", "","1 dec 1993","2333-44112", 8000,seniorSalesManPosition2);
		Employee salesPerson1 = new Employee("Tom","", "", "1 Jan 1998","222-3345",900,salesManPosition1);
		Employee salesPerson2 = new Employee("Sue","", "", "1 Jan 1998","222-3345",900,salesManPosition2);
		Employee salesPerson3 = new Employee("Marc","", "", "1 Jan 1998","222-3345",900,salesManPosition3);
		Employee salesPerson4 = new Employee("Bill","", "", "1 Jan 1998","222-3345",900,salesManPosition4);
		Employee salesPerson5 = new Employee("Dan","", "", "1 Jan 1998","222-3345",900,salesManPosition5);

		Employee deptHeadMarketingPerson = new Employee("Anne","","", "3 July 1995", "2340-2353",90000, marketingDeptHeadPosition);
		Employee seniorMarketingPerson = new Employee("Gary", " ", "","1 dec 1993","2333-44112", 8000,seniorMarketerPosition);
